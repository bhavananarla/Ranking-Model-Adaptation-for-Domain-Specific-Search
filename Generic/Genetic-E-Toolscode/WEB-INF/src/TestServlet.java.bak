...
{	 session= req.getSession(true);
	...
	int limit=2;//Integer.parseInt((String)session.getAttribute("limit"));
...
int loop=(Integer)session.getAttribute("num_of_emp");
...
{	PrintWriter out = res.getWriter();
	...
	out.println("<a href=\"ListPage.html\"><center><h1>Ur data inserted successfully</h1><br>Home</center></a>");
	out.println("</body></html>");
      ...
      out.println("Data inserted succesfullly");
