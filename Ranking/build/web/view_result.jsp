...
<div style="position:absolute; left:700px; top:300px"><img src="images/2.jpeg" width="300"> </div>
...
String tit = null,typ = null;
	...
	try{
		...
		<tr>
		<td height="29"></td>
		<td width="224" bgcolor="#FF9900"><font size="+1"><a href="view_result1.jsp?<%=typ%>"><%=typ%></a></font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(<%=count%>)</td>
